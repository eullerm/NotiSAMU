    ...
    return RichText(
        ...
        text: TextSpan(
          children: <TextSpan>[
            TextSpan(
              text:
                  "O aplicativo tem como objetivo reunir informações sobre incidentes com medicamentos ocorridos durante o atendimento pré-hospitalar de emergência e analisar os dados para compreender o quadro dos problemas e assim poder agir para melhorar o atendimento.",
